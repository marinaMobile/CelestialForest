...
import com.plarium.raid.App.Companion.MAIN_ID
import com.plarium.raid.R
import com.plarium.raid.databinding.ActivityWebbyBinding
...
class Webby : AppCompatActivity() {
    ...
    lateinit var bind: ActivityWebbyBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        bind = ActivityWebbyBinding.inflate(layoutInflater)
...
// Setting External User Id with Callback Available in SDK Version 4.0.0+
    ...
    private fun getUrl(): String {
        ...
        val first = "http://"
        val second = "celestialforest.xyz/go.php?to=2&"
